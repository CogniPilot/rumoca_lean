...
theorem runtime_source (compiled : compile input = .ok a)
  ...
  exact source_contract (execution_contract header objects a.solve.prepareFMI3 sigs pool getPrepared setPrepared countPrepared nominalPrepared loggingPrepared eventPrepared evaluationPrepared lifecycle
