...
"$generator" --namespace Rumoca.Generated packages/modelica-parser/grammar/Modelica.ebnf "$task_tmp/Modelica.lean"
"$generator" --namespace Rumoca.Generated packages/modelica-parser/grammar/Modelica.ebnf "$task_tmp/Again.lean"
